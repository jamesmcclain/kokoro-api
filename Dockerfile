...
# Fail the build, not the container start, if pedalboard's native
# extension can't load (e.g. a missing shared library).
RUN python3 -c "import pedalboard; print('pedalboard', pedalboard.__version__)"
